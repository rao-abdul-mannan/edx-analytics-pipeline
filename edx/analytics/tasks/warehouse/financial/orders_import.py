    ...
    def insert_query(self):
        ...
        return """
            ...
            FROM (
                ...
                JOIN auth_user au ON au.username = u.username
                LEFT OUTER JOIN entitlements_courseentitlement entitlements ON (
                    entitlements.user_id = au.id
                    AND entitlements.course_uuid = cuval.value_text
                ) 
