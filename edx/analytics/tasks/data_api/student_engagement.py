...
class StudentEngagementPartitionTask(StudentEngagementTableDownstreamMixin, HivePartitionTask):
    ...
    def hive_table_task(self):
        return StudentEngagementHiveTableTask(
            warehouse_path=self.warehouse_path,
            interval_type=self.interval_type,
        )
...
class StudentEngagementDataTask(StudentEngagementTableDownstreamMixin, HiveQueryTask):
    """Execute the query on student_engagement_raw_{interval_type} Hive Table and persist the results into student_engagement_{interval_type} Hive table."""
